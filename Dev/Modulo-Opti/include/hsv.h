...
public:
	...
	void main(class CDar &dar, int i_vehicle); // main function hsv heuristic	 
	bool greedy_insertion(class CDar &dar, class CSolution &sol,bool fixed, bool noise); // greedy insertion heuristic
	...
	bool compare_solution_vehicle(class CSolution &sol1, class CSolution &sol2); // compare two solutions (vehicle version)
