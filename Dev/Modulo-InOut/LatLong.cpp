...
static Ellipsoid ellip[] = {		//converted from PeterDana website, by Eugene Reimer 2002dec
	...
	Ellipsoid(0, (char *)"Airy1830", 6377563.396, 299.3249646),
	Ellipsoid(1, (char *)"AiryModified", 6377340.189, 299.3249646),
	Ellipsoid(2, (char *)"AustralianNational", 6378160, 298.25),
	Ellipsoid(3, (char *)"Bessel1841Namibia", 6377483.865, 299.1528128),
	Ellipsoid(4, (char *)"Bessel1841", 6377397.155, 299.1528128),
	Ellipsoid(5, (char *)"Clarke1866", 6378206.4, 294.9786982),
	Ellipsoid(6, (char *)"Clarke1880", 6378249.145, 293.465),
	Ellipsoid(7, (char *)"EverestIndia1830", 6377276.345, 300.8017),
	Ellipsoid(8, (char *)"EverestSabahSarawak", 6377298.556, 300.8017),
	Ellipsoid(9, (char *)"EverestIndia1956", 6377301.243, 300.8017),
	Ellipsoid(10, (char *)"EverestMalaysia1969", 6377295.664, 300.8017),	//Dana has no datum that uses this ellipsoid!
	Ellipsoid(11, (char *)"EverestMalay_Sing", 6377304.063, 300.8017),
	Ellipsoid(12, (char *)"EverestPakistan", 6377309.613, 300.8017),
	Ellipsoid(13, (char *)"Fischer1960Modified", 6378155, 298.3),
	Ellipsoid(14, (char *)"Helmert1906", 6378200, 298.3),
	Ellipsoid(15, (char *)"Hough1960", 6378270, 297),
	Ellipsoid(16, (char *)"Indonesian1974", 6378160, 298.247),
	Ellipsoid(17, (char *)"International1924", 6378388, 297),
	Ellipsoid(18, (char *)"Krassovsky1940", 6378245, 298.3),
	Ellipsoid(19, (char *)"GRS80", 6378137, 298.257222101),
	Ellipsoid(20, (char *)"SouthAmerican1969", 6378160, 298.25),
	Ellipsoid(21, (char *)"WGS72", 6378135, 298.26),
	Ellipsoid(22, (char *)"WGS84", 6378137, 298.257223563)
};
...
static Datum datum[] = {		//converted from PeterDana website, by Eugene Reimer 2002dec
	...
	Datum(0, (char *)"NAD27_AK", eClarke1866, -5, 135, 172),	//NAD27 for Alaska Excluding Aleutians
	Datum(1, (char *)"NAD27_AK_AleutiansE", eClarke1866, -2, 152, 149),	//NAD27 for Aleutians East of 180W
	Datum(2, (char *)"NAD27_AK_AleutiansW", eClarke1866, 2, 204, 105),	//NAD27 for Aleutians West of 180W
	Datum(3, (char *)"NAD27_Bahamas", eClarke1866, -4, 154, 178),	//NAD27 for Bahamas Except SanSalvadorIsland
	Datum(4, (char *)"NAD27_Bahamas_SanSalv", eClarke1866, 1, 140, 165),	//NAD27 for Bahamas SanSalvadorIsland
	Datum(5, (char *)"NAD27_AB_BC", eClarke1866, -7, 162, 188),	//NAD27 for Canada Alberta BritishColumbia
	Datum(6, (char *)"NAD27_MB_ON", eClarke1866, -9, 157, 184),	//NAD27 for Canada Manitoba Ontario
	Datum(7, (char *)"NAD27_NB_NL_NS_QC", eClarke1866, -22, 160, 190),	//NAD27 for Canada NewBrunswick Newfoundland NovaScotia Quebec
	Datum(8, (char *)"NAD27_NT_SK", eClarke1866, 4, 159, 188),	//NAD27 for Canada NorthwestTerritories Saskatchewan
	Datum(9, (char *)"NAD27_YT", eClarke1866, -7, 139, 181),	//NAD27 for Canada Yukon
	Datum(10, (char *)"NAD27_CanalZone", eClarke1866, 0, 125, 201),	//NAD27 for CanalZone (ER: is that Panama??)
	Datum(11, (char *)"NAD27_Cuba", eClarke1866, -9, 152, 178),	//NAD27 for Cuba
	Datum(12, (char *)"NAD27_Greenland", eClarke1866, 11, 114, 195),	//NAD27 for Greenland (HayesPeninsula)
	Datum(13, (char *)"NAD27_Carribean", eClarke1866, -3, 142, 183),	//NAD27 for Antigua Barbados Barbuda Caicos Cuba DominicanRep GrandCayman Jamaica Turks
	Datum(14, (char *)"NAD27_CtrlAmerica", eClarke1866, 0, 125, 194),	//NAD27 for Belize CostaRica ElSalvador Guatemala Honduras Nicaragua
	Datum(15, (char *)"NAD27_Canada", eClarke1866, -10, 158, 187),	//NAD27 for Canada
	Datum(16, (char *)"NAD27_ConUS", eClarke1866, -8, 160, 176),	//NAD27 for CONUS
	Datum(17, (char *)"NAD27_ConUS_East", eClarke1866, -9, 161, 179),	//NAD27 for CONUS East of Mississippi Including Louisiana Missouri Minnesota
	Datum(18, (char *)"NAD27_ConUS_West", eClarke1866, -8, 159, 175),	//NAD27 for CONUS West of Mississippi Excluding Louisiana Missouri Minnesota
	Datum(19, (char *)"NAD27_Mexico", eClarke1866, -12, 130, 190),	//NAD27 for Mexico
	Datum(20, (char *)"NAD83_AK", eGRS80, 0, 0, 0),	//NAD83 for Alaska Excluding Aleutians
	Datum(21, (char *)"NAD83_AK_Aleutians", eGRS80, -2, 0, 4),	//NAD83 for Aleutians
	Datum(22, (char *)"NAD83_Canada", eGRS80, 0, 0, 0),	//NAD83 for Canada
	Datum(23, (char *)"NAD83_ConUS", eGRS80, 0, 0, 0),	//NAD83 for CONUS
	Datum(24, (char *)"NAD83_Hawaii", eGRS80, 1, 1, -1),	//NAD83 for Hawaii
	Datum(25, (char *)"NAD83_Mexico_CtrlAmerica", eGRS80, 0, 0, 0),	//NAD83 for Mexico CentralAmerica
	Datum(26, (char *)"WGS72", eWGS72, 0, 0, 0),	//WGS72 for world
	Datum(27, (char *)"WGS84", eWGS84, 0, 0, 0)	//WGS84 for world
};
...
void LatLong::LLtoUTM(int eId, double Lat, double Long, double *Northing, double *Easting, int *Zone){
...
void LatLong::UTMtoLL(int eId, double Northing, double Easting, int Zone, double& Lat, double& Long){
...
void prtDM(double D){ double M = (D - int(D)) * 60; cout << setprecision(12) << int(D) << ":" << M; }
...
void Prt(int Fmt){														//Prt: print according to Fmt bits
	...
	if (Fmt&fLLD)  { ps(); char NS = (Lat < 0 ? 'S' : 'N'), EW = (Long < 0 ? 'W' : 'E'); cout << setprecision(12) << abs(Lat) << NS << " " << abs(Long) << EW; }	//LL degrees N|S E|W 
	...
	if (Fmt&fUTs)  { ps(); cout << setprecision(12) << Z << " " << E << " " << N; }	//UTM signed          
...
void LatLong::ConvLL2WGS84(double pLat, double pLong, double *pY, double *pX)
{
	int eId = eWGS84;
	int Zone;

	LLtoUTM(eId, pLat, pLong, pY, pX, &Zone);
}
